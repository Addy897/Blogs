<script>
  ...
  <div class="flex flex-col items-center">
    ...
    {#if markdownMode}
      ...
      {:else}
        <form on:submit={handleFormSubmit} class="flex flex-col items-center">
          ...
          <div class="flex justify-between w-full sm:w-auto mt-4">
            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Publish</button>
            <button type="button" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" on:click={toggleMode}>Save as Draft</button>
          </div>
        </form>
      {/if}
    </div>
