...
<div class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    {:else if login}
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
            <section>
                <h3 class="font-bold text-2xl">Welcome to Blog</h3>
            ...
            <section class="flex flex-col justify-center items-center w-full">
                ...
                use:enhance>
                    ...
                    <span class="text-[1vw] flex justify-center w-full">Or</span>
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="phone">Phone</label>
                        <input type="number" id="phone" name="phone" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3">
                    </div>
                    <div class="mb-6 pt-3 rounded bg-gray-200">
            ...
            <section class="mt-10">
                ...
                use:enhance>
                    ...
                    <div class="mb-6 pt-3 rounded bg-gray-200">
                        ...
                        <input type="password" id="confirm_password" name="cpassword" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3" required>
                    </div>
                    <div class="flex justify-between">
                        {#if form?.serror}
                            <div class="text-red-800">{form?.errormsg}</div>
                    ...
                    <button class="bg-purple-600 hover:bg-purple-700 text-black font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign In</button>
                </form>
            </section>
        </div>
